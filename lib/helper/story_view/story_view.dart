...
import 'package:insta_profile_viewer/helper/story_view/story_video.dart' as sv;
            ...
            SafeArea(
              child: Align(
                ...
                child: Container(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: 24, vertical: 8),
                  color: usernName != null ? Colors.black54 : Colors.transparent,
                  child: usernName ?? const SizedBox.shrink(),
                ),
              ),
            ),
          ],
